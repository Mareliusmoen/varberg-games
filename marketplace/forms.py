...
class ProductForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['title'].widget = forms.TextInput(attrs={'placeholder': 'What are you selling'})
        self.fields['description'].widget = forms.Textarea(attrs={'placeholder': 'Describe the item for sale, condition, willing to trade and so on', 'class': 'custom-textarea'})
